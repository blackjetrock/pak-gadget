...
U 1 1 5EDB7D8D
P 1300 2475
F 0 "J1" H 1150 2875 50  0000 R CNN
F 1 "USB_B_Micro" H 1850 2075 50  0000 R CNN
F 2 "RP2040_minimal:USB_Micro-B_Amphenol_10103594-0001LF_Horizontal_modified" H 1450 2425 50  0001 C CNN
...
U 1 1 5EDEBEA6
P 1200 2975
F 0 "#PWR01" H 1200 2725 50  0001 C CNN
F 1 "GND" H 1205 2802 50  0000 C CNN
...
U 1 1 5F04C8B7
P 3000 2275
F 0 "U1" H 3000 2517 50  0000 C CNN
F 1 "NCP1117-3.3_SOT223" H 3000 2426 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-223-3_TabPin2" H 3000 2475 50  0001 C CNN
F 3 "http://www.onsemi.com/pub_link/Collateral/NCP1117-D.PDF" H 3100 2025 50  0001 C CNN
	1    3000 2275
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F06A60B
P 3000 2625
F 0 "#PWR05" H 3000 2375 50  0001 C CNN
F 1 "GND" H 2850 2575 50  0000 C CNN
...
U 1 1 5F077314
P 3700 2225
F 0 "#PWR09" H 3700 2075 50  0001 C CNN
F 1 "+3V3" H 3715 2398 50  0000 C CNN
...
U 1 1 5F09255D
P 2300 2475
F 0 "C1" H 2415 2521 50  0000 L CNN
F 1 "10u" H 2415 2430 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 2338 2325 50  0001 C CNN
...
U 1 1 5F0930A1
P 3700 2475
F 0 "C4" H 3815 2521 50  0000 L CNN
F 1 "10u" H 3815 2430 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 3738 2325 50  0001 C CNN
...
U 1 1 5F093D45
P 2300 2675
F 0 "#PWR04" H 2300 2425 50  0001 C CNN
F 1 "GND" H 2150 2625 50  0000 C CNN
...
U 1 1 5F0A1049
P 3700 2675
F 0 "#PWR010" H 3700 2425 50  0001 C CNN
F 1 "GND" H 3550 2625 50  0000 C CNN
...
Wire Wire Line
	1600 2575 1950 2575
Text Label 1950 2475 2    50   ~ 0
USB_D+
Text Label 1950 2575 2    50   ~ 0
USB_D-
NoConn ~ 1600 2675
Wire Wire Line
...
U 1 1 614DC28D
P 1750 2275
F 0 "D1" H 1750 2059 50  0000 C CNN
F 1 "PMEG3010ER" H 1750 2150 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-123" H 1750 2275 50  0001 C CNN
...
Wire Wire Line
	2150 2275 2300 2275
Text Notes 600  925  0    50   ~ 0
VBat from \norganiser
$Comp
L New_Library:Si2302CDS-n-channel TR1
U 1 1 6153033C
P 2050 1300
F 0 "TR1" H 2328 1346 50  0000 L CNN
F 1 "Si2302CDS-n-channel" H 2328 1255 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 2080 1450 20  0001 C CNN
...
U 1 1 6155EE33
P 1175 975
F 0 "J5" H 1050 550 50  0000 C CNN
F 1 "Conn_01x02_Female" H 725 625 50  0000 C CNN
F 2 "Connector_PinHeader_1.00mm:PinHeader_1x02_P1.00mm_Vertical_SMD_Pin1Left" H 1175 975 50  0001 C CNN
...
U 1 1 6157B21C
P 4500 1225
F 0 "R8" H 4559 1271 50  0000 L CNN
F 1 "R_Small" H 4559 1180 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 4500 1225 50  0001 C CNN
...
U 1 1 6157B64E
P 4500 1525
F 0 "R9" H 4559 1571 50  0000 L CNN
F 1 "R_Small" H 4559 1480 50  0000 L CNN
...
Wire Wire Line
	4500 1750 4500 1625
Text GLabel 5050 1375 2    50   Input ~ 0
BATSENSE
Wire Wire Line
	5050 1375 4500 1375
